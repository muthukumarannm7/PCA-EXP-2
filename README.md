...
## AIM:
## ENTER YOUR NAME: MUTHUKUMARAN NM
## ENTER YOUR REGISTER NO: 212225040268
## EX. NO: 2
## DATE: 31/07/2026
...
## OUTPUT:
<img width="812" height="240" alt="image" src="https://github.com/user-attachments/assets/481183a0-419d-4c5c-a0ae-c12019e25fcb" />


## RESULT:
The host took 600 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.842582 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
